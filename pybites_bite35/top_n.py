...
def get_largest_number(numbers, n=3) -> heapq:
    return heapq.nlargest(n, numbers)


def get_latest_dates(dates, n=3) -> heapq:
    return heapq.nlargest(n, dates)


def get_highest_earnings(earnings_mln, n=3) -> heapq:
    return heapq.nlargest(n, earnings_mln, key=operator.itemgetter("earnings"))
