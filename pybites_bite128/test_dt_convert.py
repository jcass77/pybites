...
def test_years_ago():
    assert years_ago("pybites_bite8 Aug, 2015") == 3
    assert years_ago("pybites_bite6 Sep, 2014") == 4
    assert years_ago("pybites_bite1 Oct, 2010") == 8
...
def test_years_ago_wrong_input():
    with pytest.raises(ValueError):
        ...
        assert years_ago("pybites_bite6 Sept, 2014") == 4
...
def test_convert_eu_to_us_date():
    ...
    assert convert_eu_to_us_date("pybites_bite1/3/2004") == "03/01/2004"
...
def test_convert_eu_to_us_date_invalid_month():
    with pytest.raises(ValueError):
        convert_eu_to_us_date("11/pybites_bite13/2002")


def test_convert_eu_to_us_date_invalid_year():
    with pytest.raises(ValueError):
        convert_eu_to_us_date("11/pybites_bite13/year")
