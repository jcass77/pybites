...
def test_rotation_of_n_bigger_than_string():
    ...
    pybites_bite1. A slice of size n moved from one end of the string to the other
    ...
    Case pybites_bite1) With a slice method, slicing an entire string and placing
